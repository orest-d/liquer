...
def index():
    return """<h1><a href="https://matplotlib.org/">Matplotlib</a> and <a href="https://plot.ly/python/">Plotly</a> charts</h1>
    <ul>
    <li><a href="/liquer/q/data/data.html">data</a></li>
    <li><a href="/liquer/q/data/data.csv">data (csv)</a></li>
    <li><a href="/liquer/q/data/mpl-xy-xcol-ycol">Matplotlib chart</a></li>
    <li><a href="/liquer/q/data/plotly_chart-xy-xcol-ycol">Plotly chart</a></li>
    </ul>
    """
