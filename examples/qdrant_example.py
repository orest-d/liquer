...
import liquer.ext.lq_qdrant as qdr
...
# Initialize qdrant with a temporary directory
import tempfile
...
def index():
    return f"""<h1>Hello qdrant</h1>
    Index is in {temp_dir}
    <hr/>
    <ul>
    <li><a href="/liquer/q/ns-qdrant/web/index.html">Search</a></li>
    <li><a href="/liquer/q/ns-qdrant/search-document/result.json">Search 'document' (json)</a></li>
    <li><a href="/liquer/q/ns-qdrant/search_json?query=document">Search 'document' (query parameter API)</a></li>
    <li><a href="/liquer/q/ns-qdrant/search-document/to_html/result.html">Search 'document' (html)</a></li>
    <li><a href="/liquer/q/ns-qdrant/search-another/result.json">Search 'another' (json)</a></li>
    <li><a href="/liquer/q/ns-qdrant/search-another/to_html/result.html">Search 'another' (html)</a></li>
    <li><a href="/liquer/q/ns-qdrant/reindex_store">reindex store</a></li>
    </ul>
    <br/>
    <hr/>
    <ul>
